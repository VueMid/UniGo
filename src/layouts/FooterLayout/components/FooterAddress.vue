<template>
  <div>
    ...
    <a
      class="active:opacity-70 border-[2px] border-yellow duration-150 mt-[10px] px-[16px] py-[8px] bg-darker-gray rounded-[50px] text-yellow flex flex-row justify-center items-center gap-2"
